...
qboolean GLimp_SetMode( int mode, qboolean fullscreenFlag, qboolean noborder ) {
    ...
    if (mode == -1) {
        ...
        // Standard modes (added more common resolutions for x64)
        switch (mode) {
            case 0: width = 640; height = 480; break;
            case 1: width = 800; height = 600; break;
            case 2: width = 1024; height = 768; break;
            case 3: width = 1152; height = 864; break;
            case 4: width = 1280; height = 1024; break;
            case 5: width = 1600; height = 1200; break;
            case 6: width = 1920; height = 1080; break;
            case 7: width = 1366; height = 768; break;
            case 8: width = 1440; height = 900; break;
            case 9: width = 1680; height = 1050; break;
            case 10: width = 1920; height = 1200; break;
            case 11: width = 2560; height = 1440; break;
            case 12: width = 3840; height = 2160; break;
...
void IN_ProcessEvents( void ) {
    ...
    while (SDL_PollEvent(&event)) {
        switch (event.type) {
            ...
            case SDL_KEYDOWN:
            case SDL_KEYUP: {
                // Use keycode for character input, scancode for special keys
                ...
                if (keycode > 0 && keycode < 128) {
                    ...
                    // Map special keys using scancode
